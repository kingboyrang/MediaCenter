...
- (void)drawRect:(CGRect)rect {
    ...
    /**< Titles */
    {
        ...
        for (int i = 0; i < itemCount; i++)
        {
            ...
            CGSize titleSize = [title sizeWithFont:titleFont constrainedToSize:titleRect.size lineBreakMode:NSLineBreakByTruncatingTail];
            ...
            [title drawInRect:CGRectMake(CGRectGetMinX(titleRect) + (titleRect.size.width - titleSize.width)/2.0f, 
                ...
                lineBreakMode:NSLineBreakByTruncatingTail
                    alignment:NSTextAlignmentCenter];//UILineBreakModeTailTruncation
